...
export const COMPANY_INFO = {
  ...
  heroSubheadline:
    "De MVP a enterprise: desarrollo ágil con estándares de calidad internacional. Stack moderno, equipo senior, resultados medibles.",
  description:
    "Estudio de innovación tecnológica fundado por Lucas Benavidez y Juan Cruz Ferri, especializado en desarrollo web, inteligencia artificial, diseño UX/UI y soluciones cloud.",
...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    description:
      "Soluciones de IA y Machine Learning para automatizar y optimizar procesos.",
  ...
  },
  {
    ...
    title: "Diseño UX/UI",
    description:
      "Interfaces intuitivas y atractivas centradas en la experiencia del usuario.",
  ...
  },
  {
    ...
    title: "Cloud & DevOps",
    description:
      "Infraestructura cloud escalable, segura y optimizada para tu negocio.",
  ...
  },
  {
    ...
    description:
      "Protección integral contra amenazas y auditorías de seguridad.",
  ...
  },
  {
    ...
    description:
      "Asesoramiento estratégico para transformar tu negocio con tecnología.",
    icon: "/assets/images/pibelabs-icon-desarrollo.svg",
    features: [
...
export const PORTFOLIO_PROJECTS: PortfolioProject[] = [
  ...
  },
  {
    ...
    description:
      "Plataforma SaaS multi-tenant para gestión de inventario con automatización zero-config. Stack full-stack Node.js + React con workspaces, automatización completa con N8N, monitoreo real-time con Prometheus + Grafana, y soporte multi-industria (supermercados, restaurantes, heladerías).",
    image:
  ...
  },
  {
    ...
    description:
      "Plataforma de comercio electrónico con recomendaciones personalizadas mediante Machine Learning.",
    image:
  ...
  },
  {
    ...
    description:
      "Asistente virtual con procesamiento de lenguaje natural para atención al cliente 24/7.",
    image:
  ...
  },
  {
    ...
    description:
      "Sistema de diseño completo con componentes reutilizables y documentación interactiva.",
    image:
...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    excerpt:
      "Exploramos cómo la inteligencia artificial está transformando la manera en que construimos aplicaciones web modernas.",
    image:
  ...
  },
  {
    ...
    excerpt:
      "Técnicas avanzadas y best practices para hacer tus aplicaciones React más rápidas y eficientes.",
    image:
  ...
  },
  {
    ...
    excerpt:
      "Todo lo que necesitas saber sobre seguridad cloud, desde configuración básica hasta estrategias avanzadas.",
    image:
...
export const TEAM_MEMBERS: TeamMember[] = [
  {
    ...
    bio: "Software Engineer con perfil altamente técnico especializado en Java, Kotlin y Golang. Experto en Inteligencia Artificial trabajando con modelos de Anthropic (Claude), OpenAI (GPT), Google Gemini y Kimi K2. Arquitecto de soluciones escalables y cloud-native.",
    ...
    skills: [
      ...
      "Kotlin",
      "Golang",
      "AI/ML (Anthropic, OpenAI, Gemini)",
      "Cloud Architecture",
      "Microservices",
    ],
  },
  {
    id: "eduardo-fernandez",
    name: "Eduardo Fernández",
    role: "Software Architect",
    bio: "Arquitecto de Software senior especializado en Java y Golang. Experto en diseño de arquitecturas de alto rendimiento, microservicios y sistemas distribuidos. Líder técnico con amplia experiencia en transformación digital y modernización de aplicaciones enterprise.",
    avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=EduardoFernandez",
    social: {
      linkedin:
        "https://www.linkedin.com/in/eduardo-fernandez-java-golang-developer/",
      github: "https://github.com/efernandez",
    },
    skills: [
      "Java",
      "Golang",
